    ...
    declare namespace Db {
        ...
        namespace Administration {
            ...
            namespace User {
                ...
                export const KtpId: string;
                export const KtpKodeRt: string;
        ...
        namespace Rukuntangga {
            ...
            namespace TbDetailJenisKegiatan {
                ...
                export const DieditOleh: string;
                export const DieditTanggal: string;
                export const Dokumentasi: string;
                export const Id: string;
            ...
            namespace TbKtp {
                ...
                export const DataStatus: string;
                export const DibuatOleh: string;
                export const DibuatTanggal: string;
                export const DieditOleh: string;
                export const DieditTanggal: string;
                export const DocumentCode: string;
                export const GolonganDarah: string;
                export const Id: string;
                export const IdKecamatan: string;
                export const IdKecamatanTinggal: string;
                export const IdKelurahan: string;
                export const IdKelurahanTinggal: string;
                export const IdKota: string;
                export const IdKotaTinggal: string;
                export const IdProvinsi: string;
                export const IdProvinsiTinggal: string;
                ...
                export const PhotoRumah: string;
                ...
                export const TinggalSesuaiKtp: string;
                export const TransactionFlowId: string;
            }
            ...
            namespace TbTanyaRt {
                ...
                export const Id: string;
                export const Judul: string;
                export const KtpIdKtp: string;
                export const KtpKodeRt: string;
                export const KtpNama: string;
                export const KtpPhotoKtp: string;
                export const SystemStatus: string;
                export const tbTanyaRtDetailRow: string;
            }
            ...
            namespace TbTransactionDocumentCode {
                export const Description: string;
                export const DibuatOleh: string;
                export const DibuatTanggal: string;
                export const DieditOleh: string;
            ...
            namespace TbTransactionFlow {
                ...
                export const Id: string;
                export const IsActive: string;
                export const tbTransactionFlowDetailRow: string;
            }

            namespace TbTransactionFlowDetail {
                export const AccessButton: string;
                export const CcCreator: string;
                export const CcRequestor: string;
                export const DibuatOleh: string;
                export const DibuatTanggal: string;
                export const DieditOleh: string;
                export const DieditTanggal: string;
                ...
                export const Id: string;
                export const IsSendEmail: string;
                export const Name: string;
                export const NextStatus: string;
                export const PopupMessage: string;
                export const SendEmailTo: string;
                export const SendEmailType: string;
                export const StartStatus: string;
                export const TemplateEmailType: string;
                export const TransactionFlowId: string;
                export const TransactionStatusCode: string;
            }

            namespace TbTransactionStatus {
                export const Code: string;
                export const DibuatOleh: string;
                export const DibuatTanggal: string;
                export const DieditOleh: string;
