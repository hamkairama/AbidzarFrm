...
namespace AbidzarFrm.Rukuntangga.Endpoints
{
    ...
    using MyRepository = Repositories.TbTransactionFlowRepository;
    using MyRow = Entities.TbTransactionFlowRow;

    [RoutePrefix("Services/Rukuntangga/TbTransactionFlow"), Route("{action}")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class TbTransactionFlowController : ServiceEndpoint
    {
