...
namespace AbidzarFrm.Rukuntangga.Endpoints
{
    ...
    using MyRepository = Repositories.TbGaleryRepository;
    using MyRow = Entities.TbGaleryRow;

    [RoutePrefix("Services/Rukuntangga/TbGalery"), Route("{action}")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class TbGaleryController : ServiceEndpoint
    {
