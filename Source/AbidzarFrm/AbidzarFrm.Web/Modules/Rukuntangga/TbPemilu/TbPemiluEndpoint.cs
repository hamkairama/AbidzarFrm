...
namespace AbidzarFrm.Rukuntangga.Endpoints
{
    ...
    using MyRepository = Repositories.TbPemiluRepository;
    using MyRow = Entities.TbPemiluRow;

    [RoutePrefix("Services/Rukuntangga/TbPemilu"), Route("{action}")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class TbPemiluController : ServiceEndpoint
    {
