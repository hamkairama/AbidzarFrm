...
namespace AbidzarFrm.Rukuntangga.Entities
{
    ...
    [ConnectionKey("Rukuntangga"), Module("Rukuntangga"), TableName("[dbo].[TbAutentikasiToken]")]
    [DisplayName("Autentikasi Token"), InstanceName("Autentikasi Token")]
    [ReadPermission("Security:AutentikasiToken")]
    [ModifyPermission("Security:AutentikasiToken")]
    public sealed class TbAutentikasiTokenRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Token"), NotNull, QuickSearch]
        public String Token
        {
        ...
        [DisplayName("Aplikasi"), Size(100), NotNull]
        public String Aplikasi
        {
            get { return Fields.Aplikasi[this]; }
            set { Fields.Aplikasi[this] = value; }
        }
        ...
        {
            get { return Fields.Token; }
        }

        public static readonly RowFields Fields = new RowFields().Init();

        public TbAutentikasiTokenRow()
            : base(Fields)
        {
        }
