...
namespace AbidzarFrm.Rukuntangga.Endpoints
{
    ...
    using MyRepository = Repositories.TbTransactionFlowDetailRepository;
    using MyRow = Entities.TbTransactionFlowDetailRow;

    [RoutePrefix("Services/Rukuntangga/TbTransactionFlowDetail"), Route("{action}")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class TbTransactionFlowDetailController : ServiceEndpoint
    {
