...
namespace AbidzarFrm.BasicSamples.Endpoints
{
    using Serenity;
    using Serenity.Data;
    ...
    public class VSGalleryQAController : ServiceEndpoint
    {
        ...
        private List<VSGalleryQAThread> LoadFromLocalCopy()
        {
            ...
            if (!System.IO.File.Exists(path))
            {
                ...
                var bytes = new WebClient().DownloadData("https://github.com/volkanceylan/AbidzarFrm/raw/master/AbidzarFrm/AbidzarFrm.Web/" + 
